...
L["Description_FixCombatMessage"] = "Sometimes UI or addon cause it off"
L["CALLME_ON"]          = "Alarm when Someone calls My Name"
L["CALLME_SOUND"]       = "Alarm Sound"
L["Play"]               = true
L["TOOLTIP_UNIT_GS"]    = "Show GS/ILvl on Target Tooltip(After Inpection)"
L["INSPECT_GS"]         = "Show GearScore on Inspection"
